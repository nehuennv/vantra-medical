            ...
            <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 sm:p-6">
                ...
                >
                    ...
                    <div className="w-full md:w-80 bg-slate-50/80 border-r border-slate-100 flex flex-col shrink-0 relative overflow-hidden">
                        ...
                        <div className="absolute top-0 left-0 w-full h-40 bg-gradient-to-b from-indigo-50/50 to-transparent pointer-events-none" />
                        ...
                        <div className="p-8 relative z-10">
                            {loading ? (
                                ...
                                <div className="flex flex-col items-center text-center">
                                    <div className="h-28 w-28 rounded-full bg-white shadow-xl flex items-center justify-center text-4xl font-black text-indigo-600 ring-4 ring-white mb-4 relative">
                            ...
                            {[
                                ...
                                <button
                                    ...
                                    className={cn(
                                        ...
                                        activeTab === tab.id
                                            ? "bg-white shadow-lg shadow-slate-100 text-indigo-600 ring-1 ring-indigo-50"
                                            : "text-slate-400 hover:text-slate-700 hover:bg-white/60"
                                    )}
                                >
                                    <div className={cn("h-10 w-10 rounded-xl flex items-center justify-center transition-colors", activeTab === tab.id ? "bg-indigo-50 text-indigo-600" : "bg-transparent text-slate-400 group-hover:bg-slate-100")}>
                                        <tab.icon className="h-5 w-5" />
                                    </div>
                                    <span className="relative z-10">{tab.label}</span>
                                    {activeTab === tab.id && <div className="absolute right-0 top-1/2 -translate-y-1/2 w-1 h-8 bg-indigo-500 rounded-l-full" />}
                                </button>
                            ))}
                        </div>
                    ...
                    <div className="flex-1 flex flex-col relative bg-white">
                                ...
                                <div className="max-w-3xl">
                                        ...
                                        <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.3 }} className="space-y-8">
                                            ...
                                            <div className="grid grid-cols-3 gap-4">
                                                {[
                                                    ...
                                                    <div key={i} className="bg-slate-50 rounded-2xl p-4 border border-slate-100 focus-within:ring-2 focus-within:ring-indigo-500/20 transition-all">
                                                        <div className="flex items-center gap-2 mb-2 text-slate-400">
                                                            <vital.icon className="h-4 w-4" />
                                                            <span className="text-[10px] font-bold uppercase tracking-wider">{vital.label}</span>
                                                        </div>
                                                        <input
                                                            className="w-full bg-transparent border-none p-0 text-lg font-bold text-slate-700 placeholder:text-slate-300 focus:ring-0"
                                            ...
                                            <div className="space-y-6">
                                                <div className="space-y-3">
                                                    ...
                                                    <div className="relative group">
                                                        <div className="absolute left-4 top-1/2 -translate-y-1/2 p-1.5 bg-indigo-50 text-indigo-500 rounded-lg group-focus-within:bg-indigo-100 transition-colors">
                                                        ...
                                                        <input
                                                            ...
                                                            className="w-full pl-14 pr-4 py-4 rounded-2xl bg-slate-50 border border-slate-100 text-slate-800 font-bold focus:bg-white focus:border-indigo-500 focus:ring-4 focus:ring-indigo-500/10 outline-none transition-all placeholder:font-normal placeholder:text-slate-400"
                                                        />
                                                    </div>
                                                </div>
                                                ...
                                                <div className="space-y-3 flex-1 flex flex-col">
                                                    ...
                                                    <textarea
                                                        ...
                                                        className="w-full p-6 rounded-2xl bg-white border border-slate-200 text-slate-600 font-medium leading-relaxed focus:border-indigo-500 focus:ring-4 focus:ring-indigo-500/10 outline-none transition-all resize-none min-h-[200px] shadow-sm"
                                                    />
                                                </div>
                                            </div>
                                        </motion.div>
                                            ...
                                            <div className="relative pl-8 border-l-2 border-slate-100 space-y-12 py-2">
                                                {data.history.length === 0 ? (
                                                    ...
                                                    <div key={evt.id} className="relative group">
                                                        <div className="absolute -left-[41px] top-0 h-6 w-6 rounded-full border-4 border-white bg-slate-200 group-hover:bg-indigo-500 transition-colors shadow-sm z-10" />
                                                        <div className="bg-white p-6 rounded-3xl border border-slate-100 shadow-sm hover:shadow-md transition-all group-hover:border-indigo-100/50">
                                                            <div className="flex justify-between mb-3">
                                                                <div className="flex items-center gap-3">
                                                                    <span className="bg-indigo-50 text-indigo-700 font-bold text-xs px-3 py-1 rounded-full">{evt.diagnosis || 'Consulta'}</span>
                                    ...
                                    {activeTab === 'files' && (
                                        <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.3 }} className="h-full">
                                            <div className="border-2 border-dashed border-slate-200 bg-slate-50/50 hover:bg-slate-50 hover:border-indigo-400 rounded-3xl p-12 flex flex-col items-center justify-center gap-4 transition-all cursor-pointer group mb-10">
                                                <div className="h-16 w-16 bg-white rounded-2xl shadow-sm flex items-center justify-center text-slate-300 group-hover:text-indigo-500 group-hover:scale-110 transition-all duration-300">
                                                    <Upload className="h-8 w-8" />
                                                </div>
                                                <div className="text-center">
                                                    <p className="font-bold text-slate-700 group-hover:text-indigo-700 transition-colors">Click para subir archivos</p>
                                            ...
                                            <div className="space-y-3">
                                                {data.files && data.files.length > 0 ? data.files.map((file, i) => (
                                                    <div key={i} className="flex items-center gap-4 p-4 bg-white border border-slate-100 rounded-2xl hover:shadow-md transition-all group">
                                                        <div className="h-12 w-12 bg-indigo-50 text-indigo-600 rounded-xl flex items-center justify-center font-bold text-xs uppercase">
                                                            FILE
                                                        </div>
                                                        <div className="flex-1">
                                                            <p className="font-bold text-slate-800 text-sm group-hover:text-indigo-700 transition-colors">{file.name}</p>
                        ...
                        <div className="p-8 pt-0 mt-auto flex justify-end gap-3 bg-white z-20">
                            ...
                            <Button onClick={handleSave} disabled={saving} className="bg-indigo-600 hover:bg-indigo-700 text-white px-8 rounded-xl font-bold h-12 shadow-lg shadow-indigo-600/20 active:scale-95 transition-all">
